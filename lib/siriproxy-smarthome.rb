...
listen_for /Küche an/i do
    ...
    url = "https://mobile.rwe-smarthome.de/MobileWeb/JsonApi/SetActuatorValue/?Id=9fc52200-1747-408a-a82f-8ee294511b70&Value=1"
    request_completed
end

listen_for /Regal an/i do
    say "Regal Licht wird eingeschaltet"
    url = "https://mobile.rwe-smarthome.de/MobileWeb/JsonApi/SetActuatorValue/?Id=a0a69125-00b5-489d-88e7-0ae2cf5acc0b&Value=1"
    request_completed
end

listen_for /Kugel an/i do
    say "Kugellampe wird eingeschaltet"
    url = "https://mobile.rwe-smarthome.de/MobileWeb/JsonApi/SetActuatorValue/?Id=5786cbbe-0b69-4bf2-b665-7c89b0dda38f&Value=1"
    request_completed
end

listen_for /Fernseher an/i do
    say "Medientechnik wird eingeschaltet"
    url = "https://mobile.rwe-smarthome.de/MobileWeb/JsonApi/SetActuatorValue/?Id=80dc02a2-bcc7-460f-bace-ea0d97ea9ba6&Value=1"
    request_completed
end

listen_for /Schlafzimmer an/i do
    say "Schlafzimmer wird eingeschaltet"
    url = "https://mobile.rwe-smarthome.de/MobileWeb/JsonApi/SetActuatorValue/?Id=7622bd1a-e9da-4047-80b4-750376932c95&Value=1"
    request_completed
end

listen_for /Arbeitszimmer an/i do
    say "Arbeitszimmer wird eingeschaltet"
    url = "https://mobile.rwe-smarthome.de/MobileWeb/JsonApi/SetActuatorValue/?Id=09c94f50-f75a-457d-a8ad-e1c761df5d04&Value=1"
    request_completed
end
